...
var con = mysql.createConnection({host: "localhost",user: "root",password: "a",database: "shopping"});
        ...
        <br><br><br><br><br><br><br><br><br>
            <center>
                <form method="post" action="/">
                    ...
                    <button class="btn" formaction="signinsuccess" name="submitbtn">
                        Sign In
                    </button>
                </form>
            </center>    
...
app.post('/signinsuccess', urlencodedParser, function(req, res){
    var username = req.body.username;
    var password = req.body.password;
    console.log(username);
    console.log(password);
    ...
    //console.log(pwd);
    var result;
    con.query(pwd , function (err, result, obs) {
        if (err) throw err;
        console.log(result);
        console.log(JSON.parse(password));// stringify(result).);
    });
    var actualpwd =JSON.parse(password);
    //actualpwd = parse(actualpwd);
    var rr = `
    <h1>lets go Shopping</h1>
    <form method="post" action="/">
    <button formaction="shop" name="shop">Shop</button>
        ...
        <div class="container">
            <center>
                <form method="post" action="/">
                    ...
                    <button class="btn" formaction="shopsuccess" name="submitbtn">
                        Checkout and pay
                    </button>
                </form>
            </center>    
...
app.post('/shopsuccess', function(req, res){
    var applequantity = req.body.applequantity;
    var bananaquantity = req.body.bananaquantity;
    var orangequantity = req.body.orangequantity;
    var waterquantity = req.body.waterquantity;
    var chikkuquantity = req.body.chikkuquantity;

    var sqlquerry = "insert into transactions values("+applequantity+","+bananaquantity+","+orangequantity+","+waterquantity+","+chikkuquantity+");";
